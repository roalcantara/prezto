...
alias lexa='exa --classify --color=always'
alias l='lexa --oneline' # Lists in one column, hidden files.
alias ll='lexa --binary --icons --long --header --accessed --modified --created --git --time-style=iso'    # Lists human readable sizes.
alias lr='ll -R'                   # Lists human readable sizes, recursively.
alias la='ll --all'                # Lists human readable sizes, hidden files.
alias lm='la | "$PAGER"'           # Lists human readable sizes, hidden files through pager.
alias lx='ll --sort=Extension'     # Lists sorted by extension (GNU only).
alias lk='la --sort=size -r'       # Lists sorted by size, largest last.
alias lt='la --sort=modified -r'   # Lists sorted by date, most recent last.
